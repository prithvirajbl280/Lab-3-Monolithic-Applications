...
from products.__init__product import list_products
from cart import add_to_cart as ac, get_cart, remove_from_cart, delete_cart
from checkout.__init__checkout import checkout as chk, complete_checkout
...
def product(product_id):
    product = __init__product.get_product(product_id)
...
def product_page():
    if request.method == 'POST':
        ...
        __init__product.add_product({"name": product_name, "cost": product_cost, "qty": product_quantity,
